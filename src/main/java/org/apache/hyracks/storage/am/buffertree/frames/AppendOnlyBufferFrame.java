 ...
 */
public class AppendOnlyBufferFrame implements IPrimaryBufferFrame {
    ...
    protected final UnslottedTupleManager tupleManager;

    //state variables
    protected ICachedPage page;
    protected ByteBuffer buf;

    public AppendOnlyBufferFrame(int size, ITupleWriter writer, ITupleComparator comparator) {
        this.size = size;
        this.tupleManager = new UnslottedTupleManager(this, headerSize, size, writer, comparator);
    }
    ...
    public static class Factory implements IPrimaryBufferFrameFactory {
        ...
        public IPrimaryBufferFrame createFrame() {
            return new AppendOnlyBufferFrame(size, writer, comparator);
        }
    }
}
